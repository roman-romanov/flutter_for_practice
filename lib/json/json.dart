import 'package:flutter_for_practice/json/address.dart';
...
const jsonString = '''[
  {
    ...
    "age": 17,
    "addreses": [
      {"city": "Москва", "street": "Баумана", "house": "12а", "flat": 12},
      {"city": "Новосибирск", "street": "Батурина", "house": "1", "flat": 1},
      {"city": "Питер", "street": "Моховая", "house": "198г", "flat": 561}
    ]
  },
  {
    "name": "Петр",
    ...
    "age": 17,
    "addreses": [
      {"city": "Москва", "street": "Мира", "house": "54", "flat": 67},
      {"city": "Казань", "street": "Ленина", "house": "23", "flat": 56},
      {"city": "Пенза", "street": "Карла Маркса", "house": "13б", "flat": 12}
    ]
  }
]''';
